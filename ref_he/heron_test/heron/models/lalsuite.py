...
class LALSimulationApproximant(WaveformApproximant):
    ...
    def args(self):
        ...
        # Extract extra keys and add them to the waveform dict.
        if "hyperbolic_eccentricity" in args:
            params = lal.CreateDict()
            lalsimulation.SimInspiralWaveformParamsInsertHyperbolicEccentricity(params, args["hyperbolic_eccentricity"])
            args["params"] = params
...
class HyperbolicTD(LALSimulationApproximant):
    def __init__(self):
        super().__init__()
        self._args["approximant"] = lalsimulation.GetApproximantFromString(
            "HyperbolicTD"
